...
#### Steps to create the dynamic group:

1. Go to the Azure portal and navigate to **Azure Active Directory > Groups > New Group**.  
...
```plaintext
(device.deviceOSType -eq "Windows") and (startswith(device.deviceOSVersion, "10") or startswith(device.deviceOSVersion, "11"))
