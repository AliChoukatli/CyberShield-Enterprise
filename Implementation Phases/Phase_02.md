...
6. Click [Finish]
7. in our project We will add 10 users to AD; [Capture of 10 users on AD]
8.
9.
10. [Script](https://github.com/AliChoukatli/CyberShield-Enterprise/blob/main/IT_Support/PowerShell_Script/Add_10_users.ps1)
