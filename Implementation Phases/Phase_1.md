...
🔴 **Step 1 – Windows 11 Client Machines**
   ...
   - Click ➡️ "Install now
   - Custom
   - [Select Creat your partition and choose the space you need](https://github.com/AliChoukatli/CyberShield-Enterprise/blob/main/Screenshots/Day1_Installation_AD/Create_Partition.png) --> Next
